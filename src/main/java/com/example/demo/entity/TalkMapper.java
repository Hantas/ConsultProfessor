...
public interface TalkMapper {
    @Insert("insert into talk(talker_id, receiver_id, content, start_time, isHandle) values(#{talker_id},#{receiver_id},#{content},#{start_time},#{isHandle})")
    int talkRecord(@Param("talker_id") Long talker_id, @Param("receiver_id") Long receiver_id, @Param("content") String content, @Param("start_time") Date start_time, @Param("isHandle") boolean isHandle);
